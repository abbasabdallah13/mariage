...
const DDay = () => {
  ...
  const updateCountdown = () => {
    ...
    // return the greatest integer less than or equal to the quotient of the two numbers
  ...
  return (
    <div className='dDayContainer'>
      <div className='dDayContainer_Count'>
        <div className='dDayContainer_days'>
          <span>{format(days)}</span>
        </div>
      </div>
      <div className='dDayContainer_Count'>
        <div className='dDayContainer_hours'>
          <span>{format(hours)}</span>
        </div>
      </div>
      <div className='dDayContainer_Count'>
        <div className='dDayContainer_minutes'>
          <span>{format(minutes)}</span>
        </div>
      </div>
      <div className='dDayContainer_Count'>
        <div className='dDayContainer_seconds'>
